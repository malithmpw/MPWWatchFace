...
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.BackgroundComplicationConfigItem;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.ColorConfigItem;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.ConfigItemType;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.FontConfigItem;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.MoreOptionsConfigItem;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.PreviewAndComplicationsConfigItem;
import com.mpw.wearable.watch.mpwwatchface.model.MPWComplicationConfigData.UnreadNotificationConfigItem;
import com.mpw.wearable.watch.mpwwatchface.watchface.MPWComplicationWatchFaceService;

import java.util.ArrayList;
import java.util.concurrent.Executors;

import static com.mpw.wearable.watch.mpwwatchface.config.ColorSelectionActivity.EXTRA_SHARED_PREF;
 ...
 */
public class MPWComplicationConfigRecyclerViewAdapter
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "CompConfigAdapter";

    /**
     * Used by associated watch face ({@link MPWComplicationWatchFaceService}) to let this
    ...
    public static final int TYPE_FONT_CONFIG = 5;
    ...
    private int mTopLeftComplicationId;
    private int mTopRightComplicationId;
    private int mBottomLeftComplicationId;
    private int mBottomRightComplicationId;
    private int mBottomCenterComplicationId;
    ...
    public MPWComplicationConfigRecyclerViewAdapter(
            Context context,
        ...
        mBackgroundComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(
                        ComplicationLocation.BACKGROUND);

        mTopLeftComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(ComplicationLocation.TOP_LEFT);
        mTopRightComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(ComplicationLocation.TOP_RIGHT);
        mBottomLeftComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(ComplicationLocation.BOTTOM_LEFT);
        mBottomRightComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(ComplicationLocation.BOTTOM_RIGHT);
        mBottomCenterComplicationId =
                MPWComplicationWatchFaceService.getComplicationId(ComplicationLocation.BOTTOM_CENTER);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
                ...
                mPreviewAndComplicationsViewHolder =
                        new PreviewAndComplicationsViewHolder(
                                LayoutInflater.from(parent.getContext())
                                        .inflate(
                                                R.layout.config_list_preview_and_complications_item_layout,
                                                parent,
                                                false));
            ...
            case TYPE_FONT_CONFIG:
                viewHolder =
                        new FontPickerViewHolder(
                                LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.config_list_font_style_item, parent, false));
                break;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case TYPE_FONT_CONFIG:
                FontPickerViewHolder fontPickerViewHolder = (FontPickerViewHolder) viewHolder;
                FontConfigItem fontConfigItem = (FontConfigItem) configItemType;

                int fontResourceId = fontConfigItem.getIconResourceId();
                String fontName = fontConfigItem.getName();
                String sharedPrefStringfont = fontConfigItem.getSharedPrefString();
                Class<FontSelectionActivity> activityFont =
                        fontConfigItem.getActivityToChoosePreference();

                fontPickerViewHolder.setIcon(fontResourceId);
                fontPickerViewHolder.setName(fontName);
                fontPickerViewHolder.setSharedPrefString(sharedPrefStringfont);
                fontPickerViewHolder.setLaunchActivityToSelectColor(activityFont);
                break;
...
//        private View mWatchFaceHighlightPreviewView;
        ...
        public PreviewAndComplicationsViewHolder(final View view) {
            ...
            mRightComplicationBackground = (ImageView) view.findViewById(R.id.right_complication_background);
            mRightComplication = (ImageButton) view.findViewById(R.id.right_complication);
            mRightComplication.setOnClickListener(this);

            // Sets up Top complication preview.
            mTopComplicationBackground = (ImageView) view.findViewById(R.id.top_complication_background);
            ...
            mBottomComplicationBackground = (ImageView) view.findViewById(R.id.bottom_complication_background);
            ...
            mCenterComplicationBackground = (ImageView) view.findViewById(R.id.center_complication_background);
            mCenterComplication = (ImageButton) view.findViewById(R.id.center_complication);
        ...
        public void onClick(View view) {
            if (view.equals(mLeftComplication)) {
                ...
                launchComplicationHelperActivity(currentActivity, ComplicationLocation.TOP_LEFT);

            } else if (view.equals(mRightComplication)) {
                Log.d(TAG, "Right Complication click()");

                Activity currentActivity = (Activity) view.getContext();
                launchComplicationHelperActivity(currentActivity, ComplicationLocation.TOP_RIGHT);
            } else if (view.equals(mTopComplication)) {
                Log.d(TAG, "Top Complication click()");

                Activity currentActivity = (Activity) view.getContext();
                launchComplicationHelperActivity(currentActivity, ComplicationLocation.BOTTOM_LEFT);
            } else if (view.equals(mBottomComplication)) {
                Log.d(TAG, "Bottom Complication click()");

                Activity currentActivity = (Activity) view.getContext();
                launchComplicationHelperActivity(currentActivity, ComplicationLocation.BOTTOM_RIGHT);
            } else if (view.equals(mCenterComplication)) {
                Log.d(TAG, "Bottom Complication click()");

                Activity currentActivity = (Activity) view.getContext();
                launchComplicationHelperActivity(currentActivity, ComplicationLocation.BOTTOM_CENTER);
            }
        }
        ...
        private void launchComplicationHelperActivity(
            ...
            mSelectedComplicationId =
                    MPWComplicationWatchFaceService.getComplicationId(complicationLocation);
            ...
            if (mSelectedComplicationId >= 0) {
                ...
                int[] supportedTypes =
                        MPWComplicationWatchFaceService.getSupportedComplicationTypes(
                                complicationLocation);

                ComponentName watchFace =
                        new ComponentName(
                                currentActivity, MPWComplicationWatchFaceService.class);
                ...
                currentActivity.startActivityForResult(
                        ComplicationHelperActivity.createProviderChooserHelperIntent(
                                ...
                                mSelectedComplicationId,
                                supportedTypes),
                        MPWComplicationConfigActivity.COMPLICATION_CONFIG_REQUEST_CODE);
        ...
        public void setDefaultComplicationDrawable(int resourceId) {
            Context context = mWatchFaceBackgroundPreviewImageView.getContext();
        ...
        public void initializesColorsAndComplications() {
            ...
            final int[] complicationIds = MPWComplicationWatchFaceService.getComplicationIds();
        ...
        public void onClick(View view) {
            ...
            if (mLaunchActivityToSelectColor != null) {
                ...
                activity.startActivityForResult(
                        launchIntent,
                        MPWComplicationConfigActivity.UPDATE_COLORS_CONFIG_REQUEST_CODE);
            }
        }
    }


    public class FontPickerViewHolder extends RecyclerView.ViewHolder implements OnClickListener {

        private Button mAppearanceButton;

        private String mSharedPrefResourceString;

        private Class<FontSelectionActivity> mLaunchActivityToSelectColor;

        public FontPickerViewHolder(View view) {
            super(view);

            mAppearanceButton = (Button) view.findViewById(R.id.font_style_picker_button);
            view.setOnClickListener(this);
        }
        ...
        public void setLaunchActivityToSelectColor(Class<FontSelectionActivity> activity) {
            mLaunchActivityToSelectColor = activity;
        }
        ...
        public void onClick(View view) {
            ...
            if (mLaunchActivityToSelectColor != null) {
                ...
                activity.startActivityForResult(
                        launchIntent,
                        MPWComplicationConfigActivity.UPDATE_FONT_STYLE_CONFIG_REQUEST_CODE);
            }
        }
    }
